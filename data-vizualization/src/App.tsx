    ...
    <MDBContainer>
      <Routes>
        ...
        <Route path="/telefonia-mobile/nr-perdoruesve" element={<NrPerdoruesve />}>
          <Route path="total" element={<NumriPerdoruesveTotal />} />
          <Route path="kontrate" element={<NumriPerdoruesveKontrate />} />
          <Route path="parapagim" element={<NumriPerdoruesveParapagim />} />
        </Route>
        <Route path="/telefonia-mobile/megabytes" element={<MegaBytes />}>
          <Route path="total" element={<MegaBytesTotal />} />
          <Route path="2g" element={<MegaBytes2g />} />
          <Route path="3g" element={<MegaBytes3g />} />
          <Route path="lte" element={<MegaBytesLte />} />
        </Route>
        <Route path="/telefonia-mobile/te-hyrat" element={<TeHyrat />}>
          <Route path="ndarja-tregut" element={<NdarjaTregutMobile />} />
          <Route path="12-16" element={<TeHyratEPergjithshme1216 />} />
          <Route path="17-22" element={<TeHyratEPergjithshme1722 />} />
        </Route>
        <Route path="/telefonia-mobile/trafiku" element={<Trafiku />}>
          <Route path="brenda-rrjetit" element={<TrafikuBrendaRrjetit />} />
          <Route path="rrjeti-tjeter" element={<TrafikuTjeter />} />
          <Route path="rrjeti-nderkombetar" element={<TrafikuNderkombetar />} />
          <Route path="rrjeti-fiks" element={<TrafikuFiks />} />
          <Route path="rrjeti-terminuar" element={<TrafikuTerminuar />} />
          <Route path="hyrje" element={<IncomingTraffic />} />
          <Route path="dalje" element={<OutgoingTraffic />} />
        </Route>
        //#endregion
