...
export function MegaBytesTotal() {
  ...
  try {
    useEffect(() => {
      let link = 'http://localhost:5000/telefonia-mobile/api/sheet/MBB_Total';
      if(koha && koha !== '-;-')
        link = 'http://localhost:5000/telefonia-mobile/api/sheet/MBB_Total/' + koha;
  ...
  return (
    <>
      <div style={{ lineHeight: 10, padding: 20 }}>
        <h5 style={{ margin: 0, lineHeight: 2 }}>
          Përdorimi i MegaBytes Total - Periudha 2018-2022
        </h5>
