    ...
    return (
      <div>
            ...
            <Link to='/telefonia-mobile/nr-perdoruesve/total' id={"1"}>
                  <MDBBtn outline className='mx-2'>Numri total i përdoruesve</MDBBtn>
            </Link>
            <Link to='/telefonia-mobile/nr-perdoruesve/kontrate' id={"2"}>
                  <MDBBtn outline className='mx-2'>Përdoruesit me kontratë</MDBBtn>
            </Link>
            <Link to='/telefonia-mobile/nr-perdoruesve/parapagim' id={"3"}>
                  <MDBBtn outline className='mx-2'>Përdoruesit me parapagim</MDBBtn>
            </Link>
            </div>
      </div>
    );
